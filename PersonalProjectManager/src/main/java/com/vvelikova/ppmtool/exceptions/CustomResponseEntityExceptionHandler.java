...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler
    public final ResponseEntity<Object> handleProjectIdNotFoundException(ProjectIdNotFoundException ex, WebRequest req) {
    ...
    public final ResponseEntity<Object> handleUsernameAlreadyExistsException(UsernameAlreadyExistsException ex, WebRequest req) {
        UsernameAlreadyExistsReposnse exceptionResponse = new UsernameAlreadyExistsReposnse(ex.getMessage());
        return new ResponseEntity<>(exceptionResponse,HttpStatus.BAD_REQUEST);
    }
}
